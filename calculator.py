...
button_subtract = Button(root, text = "-",      padx = 40, pady = 20, command = lambda: add_click())
button_multiply = Button(root, text = "x",      padx = 40, pady = 20, command = lambda: add_click())
button_divide   = Button(root, text = "/",      padx = 40, pady = 20, command = lambda: add_click())
